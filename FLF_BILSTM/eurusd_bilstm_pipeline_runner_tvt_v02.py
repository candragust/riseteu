...
ROLLING_RUNNER = ROOT / "rolling_tvt_bilstm_runner_v02.py"
...
DEFAULT_OUT_DIR = ROOT / "results" / "tvt_v02" / "bilstm_pipeline_h4_tuning_last6"
...
def main():
    ...
    html = [
        ...
        "</head><body><h1>EURUSD FLF-BiLSTM Pipeline Summary (4H, tuning folds 13-18) (TVT)</h1>"
    ]
