...
def main():
    rows = []
    for path in glob.glob(str(ROOT / "results" / "hp_*_preds.csv")):
    ...
    final_cfg = {
        ...
        "lambda_coef": 0.9,
        "sigma_coef": 0.1,
        "out": "FLF_BILSTM/results/final_preds.csv",
        "history_out": "FLF_BILSTM/results/final_history.csv"
    }

    out_path = ROOT / "final_config.json"
