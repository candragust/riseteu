...
ROLLING_RUNNER = ROOT / "rolling_tvt_lstm_d1_runner_v02.py"
...
def parse_args():
    parser = argparse.ArgumentParser(description="EUR/USD 1D FLF-LSTM tuning pipeline runner on TVT v02 split.")
    parser.add_argument(
        "--base-config",
        default=str(ROOT / "configs" / "d1_ohlc" / "lstm_flf_config_d1_tvt_v02_base.json"),
    ...
    parser.add_argument(
        "--out-dir",
        default=str(ROOT / "results" / "tvt_v02" / "d1_ohlc" / "lstm_pipeline_d1_tuning_last6"),
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Run stages up to this number only.",
    )
    parser.add_argument(
        "--min-stage",
        type=int,
        default=1,
        help="Run stages starting from this number.",
    )
...
def main():
    ...
    stages: List[Dict] = [
        {
            ...
            "base": "lstm_d1_s1",
            "jobs": [
                {"name": "lstm_d1_s1_w4", "params": {"window": 4}},
                {"name": "lstm_d1_s1_w6", "params": {"window": 6}},
                {"name": "lstm_d1_s1_w8", "params": {"window": 8}},
                {"name": "lstm_d1_s1_w12", "params": {"window": 12}},
            ],
        },
        {
            "id": "stage2",
            ...
            "base": "lstm_d1_s2",
            "jobs": [
                {"name": "lstm_d1_s2_h128", "params": {"units": 128}},
                {"name": "lstm_d1_s2_h192", "params": {"units": 192}},
                {"name": "lstm_d1_s2_h256", "params": {"units": 256}},
            ],
        },
        {
            "id": "stage3",
            ...
            "base": "lstm_d1_s3",
            "jobs": [
                {"name": "lstm_d1_s3_lr5e4", "params": {"lr": 5e-4}},
                {"name": "lstm_d1_s3_lr7e4", "params": {"lr": 7e-4}},
                {"name": "lstm_d1_s3_lr9e4", "params": {"lr": 9e-4}},
            ],
        },
        {
            "id": "stage4",
            ...
            "base": "lstm_d1_s4",
            "jobs": [
                {"name": "lstm_d1_s4_lam07_sig01", "params": {"lambda_coef": 0.7, "sigma_coef": 0.1}},
                {"name": "lstm_d1_s4_lam08_sig01", "params": {"lambda_coef": 0.8, "sigma_coef": 0.1}},
                {"name": "lstm_d1_s4_lam08_sig015", "params": {"lambda_coef": 0.8, "sigma_coef": 0.15}},
                {"name": "lstm_d1_s4_lam09_sig01", "params": {"lambda_coef": 0.9, "sigma_coef": 0.1}},
            ],
        },
        {
            "id": "stage5",
            ...
            "base": "lstm_d1_s5",
            "jobs": [
                {"name": "lstm_d1_s5_b64", "params": {"batch": 64}},
                {"name": "lstm_d1_s5_b96", "params": {"batch": 96}},
                {"name": "lstm_d1_s5_b128", "params": {"batch": 128}},
            ],
        },
        {
            "id": "stage6",
            ...
            "base": "lstm_d1_s6",
            "jobs": [
                {"name": "lstm_d1_s6_e30", "params": {"epochs": 30}},
                {"name": "lstm_d1_s6_e40", "params": {"epochs": 40}},
                {"name": "lstm_d1_s6_e50", "params": {"epochs": 50}},
                {"name": "lstm_d1_s6_e60", "params": {"epochs": 60}},
            ],
        },
        {
            "id": "stage7",
            ...
            "base": "lstm_d1_s7",
            "jobs": [
                {"name": "lstm_d1_s7_base", "params": {"dropout": 0.0, "l2_reg": 0.0}},
                {"name": "lstm_d1_s7_drop005", "params": {"dropout": 0.05, "l2_reg": 0.0}},
                {"name": "lstm_d1_s7_l2_1e5", "params": {"dropout": 0.0, "l2_reg": 1e-5}},
            ],
        },
    ]
    ...
    temp_cfg.unlink(missing_ok=True)
    html = [
        "<html><head><meta charset='UTF-8'><title>EUR/USD 1D FLF-LSTM Pipeline Summary (TVT v02)</title>"
        ...
        "</head><body><h1>EUR/USD 1D FLF-LSTM Pipeline Summary (tuning folds 13-18) (TVT v02)</h1>"
    ]
    html.extend(html_sections)
    html.append("</body></html>")
    out_file = out_dir / "eurusd_lstm_d1_pipeline_tvt_v02_summary.html"
