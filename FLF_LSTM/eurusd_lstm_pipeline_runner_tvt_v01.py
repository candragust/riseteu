...
ROLLING_RUNNER = ROOT / "rolling_tvt_lstm_runner_v01.py"
...
DEFAULT_OUT_DIR = ROOT / "results" / "tvt_v01" / "lstm_pipeline_h4_tuning_last10"
...
def main():
    ...
    html = [
        ...
        "</head><body><h1>EURUSD FLF-LSTM Pipeline Summary (4H, tuning folds 12-21) (TVT)</h1>"
    ]
